...
export default function Claim() {
  ...
  useEffect(() => {
    console.log("account-", account, "isWhitelisted-", isWhitelisted, "--------replace---/---");
  ...
  useEffect(() => {
    console.log("account-", account, "isWhitelisted-", isWhitelisted, "--------getAllData");
    if (account && isWhitelisted) {
      getAllData();
    }
